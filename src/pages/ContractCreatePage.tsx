...
export default function ContractCreatePage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      setToast("Failed to create contract");
  ...
  return (
    <div className="p-6">
      ...
      {toast && (
        <div
          role="status"
          className="mb-4 flex items-center gap-2 rounded-md bg-[var(--color-danger)]/10 px-4 py-2 text-sm text-[var(--color-danger)] border border-[var(--color-danger)]/20"
        >
